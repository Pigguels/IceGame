...
public class PlayerController : MonoBehaviour
{
    ...
    [Header("Climbing:")]
    public KeyCode m_ClimbKey = KeyCode.F;

    public float m_DistanceToStartClimb = 0.5f;
    ...
    [Header("Camera:")]
    public float m_LookSensitivity = 200f;
    [Range(0f, 90f)]
    ...
    /// <summary>
    /// Returns true if the player can climb
    /// </summary>
    private bool CanClimb()
    {
        RaycastHit hit;
        if (Physics.Raycast(transform.position, transform.forward, out hit, m_CharController.radius + m_DistanceToStartClimb, ~m_IgnoreMask))
        {
